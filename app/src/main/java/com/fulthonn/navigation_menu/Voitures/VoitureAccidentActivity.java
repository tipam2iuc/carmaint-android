...
public class VoitureAccidentActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voiture_accident);
        Context context = getApplicationContext();
        this.rv = findViewById(R.id.rv_voitureAccident);
    ...
    void initDatas(){
        LocalBd.initDatas();
        LocalBd.initVoitureAccidentDatas();
        this.myVoitures=LocalBd.myVoituresAccident;
